  ...
  <div>
    <div class="headerTop">
      ...
      <div class="headerTopIcons">
        <i><a href="#"><font-awesome-icon :icon="['far', 'heart']" style="color:black" size="lg"/></a></i>
       <i> <a href="#"><img src="https://picsum.photos/99" alt="ProfilePicture" /></a></i>
      </div>
    </div>
    ...
    <div class="recordings">
      <div class="recording">
        ...
        <div class="postIcons">
          ...
          <div class="directJam">
            <a href="#"> <img src="../assets/icon.jpg" alt="jam" /></a>
          </div>
        </div>
        ...
        <img src="https://picsum.photos/99" alt="ProfilePicture" />
          ...
          <input class="postCommentText" v-model="message" placeholder="Add comment..."/>
        </div>
      </div>
    </div>
    <footer>
